        ...
        <?php foreach ($result as $result) : ?>
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              <img src="upload/<?= $result['gambar'] ?>" class="card-img-top" alt="...">
              <div class="card-body">
                ...
                <h7 class="card-title font-weight-bold"><?= $result['keterangan'] ?></h7> <br>
                <a href="edit_menu.php?id_menu=<?= $result['id_menu']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                <a href="hapus_menu.php?id_menu=<?= $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
