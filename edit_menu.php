    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="edit.php" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input type="hidden" name="id_menu" value="<?= $result[0]['id_menu'] ?>">
          <input type="text" class="form-control" id="menu1" name="nama_menu" value="<?= $result[0]['nama_menu'] ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="stok1" name="stok" value="<?= $result[0]['stok'] ?>">
        </div>
        <div class="form-group">
          <label for="harga1">Harga Menu</label>
          <input type="text" class="form-control" id="harga1" name="harga" value="<?= $result[0]['harga'] ?>">
        </div>
        <div class="form-group">
          <label for="keterangan1">Keterangan</label>
          <input type="text" class="form-control" id="keterangan1" name="keterangan" value="<?= $result[0]['keterangan'] ?>">
        </div>
        <div class="form-group">
