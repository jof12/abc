    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="keterangan1" name="keterangan">
        </div>
        <div class="form-group">
      ...
      if (isset($_POST['tambah'])) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO produk VALUES (NULL, '$nama', '$jenis', '$keterangan', '$stok', '$harga',  '$nama_file')");
